...
function MemberRegistry_getMemberData_address() {
	var param__address = document.getElementById('MemberRegistry_getMemberData_address__address').value;
	var res = MemberRegistry_instance.getMemberData(param__address);
	if(res!=null)
		document.getElementById('MemberRegistry_getMemberData_address_res').innerText = res;
}
//function MemberRegistry_publishMemberEvent
function MemberRegistry_publishMemberEvent_address_uint() {
	var param_mAddress = document.getElementById('MemberRegistry_publishMemberEvent_address_uint_mAddress').value;
	var param_eventType = document.getElementById('MemberRegistry_publishMemberEvent_address_uint_eventType').value;
	var res = MemberRegistry_instance.publishMemberEvent(param_mAddress, param_eventType);
}
